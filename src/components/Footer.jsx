...
const Footer = () => {
  return (
    <VStack alignItems={"stretch"} backgroundColor={"blackAlpha.900"} px={{base:4, lg:12}} pt={16} pb={4}>
      <HStack gap={2} flexDirection={{base:"column", lg:"row"}} alignItems={{base:"center", lg:"flex-start"}} justifyContent={"space-between"} color={"whiteAlpha.900"} as={"footer"}>
        <VStack alignItems={{base: "center",lg:"flex-start"}}>
          <Image maxW={"120px"} src={logoWhite} />
          <Text py={2} fontSize="sm">
          <UnorderedList textAlign={{base: "center", lg:"left"}} listStyleType={"none"} m={0}>
            <ListItem> 
        ...
        <HStack flexDirection={{base:"column", lg:"row"}} gap={{base:4, lg:12}} alignItems={"flex-starts"}>
          <UnorderedList textAlign={{base: "center", lg:"left"}} display={"flex"} flexDirection={"column"} justifyContent={"space-between"} m={0} listStyleType={"none"}>
            <ListItem pb={4}>
              Home
            </ListItem>
            <ListItem pb={4}>

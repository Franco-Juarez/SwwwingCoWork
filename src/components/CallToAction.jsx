...
const CallToActionSection = () => {
  return (
    <VStack backgroundPosition={"top"} backgroundRepeat={"no-repeat"} backgroundSize={"cover"} backgroundImage={ctaImg} gap={8} alignItems={{base:"center", lg:"flex-start"}} p={{base: 4, lg:12}} >
      <Heading textAlign={{base: "center", lg:"left"}} fontWeight={"400"} textTransform={"uppercase"} fontSize={"1rem"}>Find Home With Us</Heading>
      <Heading textAlign={{base: "center", lg:"left"}}>Find The Right House Over <br /> 40,000 property options</Heading>
      <Popover> 
          <PopoverTrigger>
